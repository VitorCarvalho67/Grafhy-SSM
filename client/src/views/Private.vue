...
export default defineComponent({
    ...
    methods: {
        ...
        async sendMessage() {
            try {
                const response = await axios.post(`http://localhost:9999/message_user/`, {
        ...
        async fetchMessages() {
            try {
                const response = await axios.get(`http://localhost:9999/message_user/${this.userId}/${this.contactId}`);
        ...
        async fetchLoggedInUserId() {
            try {
                const response = await axios.get(`http://localhost:9999/users/email/${this.userEmail}`);
